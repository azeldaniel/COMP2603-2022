...
public class StudentWindow extends javax.swing.JFrame {
  ...
  public void clearData() {
    ...
    programmeComboBox.setSelectedIndex(1);
  ...
  public String getStatus() {
    if (partTimeRadioButton.isSelected()) return partTimeRadioButton.getText();
    if (fullTimeRadioButton.isSelected()) return fullTimeRadioButton.getText();
    return "none";
  }
  ...
  private void initComponents() {
    ...
    programmeComboBox.setSelectedIndex(1);
    programmeComboBox.addActionListener(
  ...
  private void programmeComboBoxActionPerformed(
    java.awt.event.ActionEvent evt
  ) { //GEN-FIRST:event_programmeComboBoxActionPerformed
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger
        .getLogger(StudentWindow.class.getName())
